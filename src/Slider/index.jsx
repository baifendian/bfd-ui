...
export default React.createClass({
  ...
  render() {
    return (
      <div ref="container" onMouseMove={this.mouseMoveHandle}  onMouseUp={this.mouseUpHandle} onMouseEnter={this.mouseEnterHandle} className={classnames('bfd-seekbar', this.props.className)}>
        <div ref='bar' className="bar">
          <div ref="slider" className="slider" onMouseDown={this.mouseDownHadle}>
...
const Scale = React.createClass({
  ...
  componentDidMount() {
    ...
    let arr = this.getTick(this.tickValue);
    arr.map((tick, index) => {
